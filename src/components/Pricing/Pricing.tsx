...
export default function Pricing() {
  ...
  return (
    <section className="py-12 px-6 bg-warm-cream">
      {/* Heading */}
      <h2 className="text-5xl font-bold mb-10 text-center text-burgundy">
        Gallery
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {pricingImages.map((item) => (
          <div
            ...
            onClick={() => openModal(item)}
          >
            {/* Image Wrapper for Border */}
            <div className="border border-blush-rose rounded-xl p-2">
              <Image
                src={item.image}
                alt={item.title}
                width={400}
